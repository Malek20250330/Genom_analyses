...
setwd("/Users/melnej1/Desktop/Mahtab/Genom Analys/Evaluation")
...
pheatmap(assay(vsd)[top_genes, ], annotation_col = sample_info_filtered, show_rownames = FALSE, main = "Top 30 Variable Genes")
