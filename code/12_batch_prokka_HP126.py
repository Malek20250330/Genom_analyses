...
# Set paths
export INPUT_DIR=/home/mahtam/Genom_analyses/Processed_data/pilon_polished_HP126
export REF_DIR=/home/mahtam/Genom_analyses
export OUTPUT_DIR=/home/mahtam/Genom_analyses/Annotation_data/Prokka_annotation_HP126
mkdir -p $OUTPUT_DIR

# Copy data to temporary directory
cp $INPUT_DIR/pilon_polished_HP126.fasta $REF_DIR/protein.faa $SNIC_TMP/  
cd $SNIC_TMP
